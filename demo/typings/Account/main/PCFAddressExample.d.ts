  ...
  namespace Forms {
   namespace PCFAddressExample {
    type FormContext = Xrm.FormContext & {
     ...
     getAttribute(attributeName: "olf_address1line1"): Xrm.Attributes.StringAttribute;
     ...
     getAttribute(attributeName: "address1_county"): Xrm.Attributes.StringAttribute;
     ...
     getControl(controlName: "olf_address1line1"): Xrm.Controls.StringControl;
     ...
     getControl(controlName: "address1_county"): Xrm.Controls.StringControl;
      ...
      sections: Xrm.Collection.ItemCollection<Xrm.Controls.Section> & {
       ...
       get(sectionName: "ADDRESS"): Xrm.Controls.Section & {
        controls: Xrm.Collection.ItemCollection<Xrm.Controls.Control> & {
         ...
         get(controlName: "olf_address1line1"): Xrm.Controls.StringControl;
         ...
         get(controlName: "address1_county"): Xrm.Controls.StringControl;

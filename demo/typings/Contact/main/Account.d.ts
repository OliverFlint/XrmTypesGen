  ...
  namespace Forms {
   namespace Account {
    type FormContext = Xrm.FormContext & {
     ...
     getAttribute(attributeName: "name"): Xrm.Attributes.Attribute;
     ...
     getControl(controlName: "name"): Xrm.Controls.Control;
    ...
    type Data = Xrm.Data & {
     attributes: Xrm.Collection.ItemCollection<Xrm.Attributes.Attribute> & {;
      ...
      get(AttributeName: "name"): Xrm.Attributes.Attribute;
      get(AttributeName: "DocumentsSubGrid"): Xrm.Attributes.Attribute;
      get(AttributeName: "name"): Xrm.Attributes.Attribute;
      get(AttributeName: "primarycontactid"): Xrm.Attributes.Attribute;
      get(AttributeName: "primarycontactid"): Xrm.Attributes.Attribute;
     };
    };
    type Ui = Xrm.Ui & {
     ...
     controls: Xrm.Collection.ItemCollection<Xrm.Attributes.Control> & {;
      ...
      get(controlName: "name"): Xrm.Controls.Control;

  ...
  namespace Ext.Forms.account.main.Account {
    ...
    namespace Extensions {
      ...
      type Tabs = Xrm.Collection.ItemCollection<Xrm.Controls.Tab> & {
        ...
        /**
         * Gets the `AssetsAndLocationsTab` tab.
         *
         * @returns `Xrm.Controls.Tab`.
         */
      ...
      type AssetsAndLocationsTabTabControl = Xrm.Controls.Tab & {
      ...
      type AssetsAndLocationsTabTabSections = Xrm.Collection.ItemCollection<Xrm.Controls.Section> & {
        /**
         * Gets the `AssetsAndLocationsSection` section.
         *
         * @returns `Xrm.Controls.Section`.
         */
        get(
      ...
      type AssetsAndLocationsSectionSectionControl = Xrm.Controls.Section & {
      ...
      type AssetsAndLocationsSectionSectionControls = Xrm.Collection.ItemCollection<Xrm.Controls.Control> & {
        /**
         * Gets the `name` control.
         *
         * @returns `Xrm.Controls.StringControl`.
